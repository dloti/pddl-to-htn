...
(:requirements :durative-actions :fluents :equality)
(:predicates
...
(:durative-action switch_on
 ...
 :effect
	(and (at start  (not (power_avail ?s))) (at start  (not (calibrated ?i))) (at end  (power_on ?i))))
...
(:durative-action take_image
 ...
 :effect
	(and (at end  (increase (data-stored) (data ?d ?m))) (at end  (have_image ?d ?m)) (at start  (decrease (data_capacity ?s) (data ?d ?m)))))
