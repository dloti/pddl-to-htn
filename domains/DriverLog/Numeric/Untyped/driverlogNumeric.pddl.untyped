...
(:functions
	 (time-to-walk ?l1 ?l2) (time-to-drive ?l1 ?l2) (driven) (walked))
...
(:action load-truck
 ...
 :effect
	(and (in ?obj ?truck) (not (at ?obj ?loc))))
...
(:action drive-truck
 ...
 :effect
	(and (at ?truck ?loc-to) (not (at ?truck ?loc-from)) (increase (driven) (time-to-drive ?loc-from ?loc-to))))
...
(:action walk
 ...
 :effect
	(and (at ?driver ?loc-to) (not (at ?driver ?loc-from)) (increase (walked) (time-to-walk ?loc-from ?loc-to))))
