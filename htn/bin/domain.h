...
public:
	...
	void printHDDLMethod( Condition &c, std::ostream &taskOs, std::ostream &os, const std::string &s,  const std::string &tag, const std::string &t) {
				std::string p("-");
				taskOs << "(:task " << parametrizeHDDLCondition( c, s + p) <<std::endl;
				taskOs << ")"<<std::endl;
				os << "( :method " << parametrizeHDDLCondition( c, s + p + tag) <<std::endl;
	...
	void printHDDLMethod1( Condition &c, std::ostream &taskOs, std::ostream &os, const std::string &s, const std::string &tag, const std::string &t) {
				std::string p("-");
				os << "( :method " << parametrizeHDDLCondition( c, s + p + tag) <<std::endl;
				os << "\t:task"<<parametrizeCondition( c, s + p, false)<<std::endl;
